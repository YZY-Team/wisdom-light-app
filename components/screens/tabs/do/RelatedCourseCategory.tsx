      ...
      <View className="mt-4 flex-row justify-start px-6 mb-4">
        {Object.values(TabType).map((tab) => (
          <Pressable
            ...
            {activeTab === tab && (
              <View className="absolute bottom-0 left-0 h-1 w-full bg-[#1483FD]" />
            )}
          </Pressable>
        ))}
      </View>
          ...
          <View className="w-[320px] bg-white rounded-[12px] overflow-hidden">
            ...
            <View className="px-7 mt-4 gap-2">
              ...
              <Pressable 
                ...
                className={`flex-row justify-between items-center py-3 px-4 rounded-[6px] bg-[#1483FD0D] ${
